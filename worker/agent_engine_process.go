...
func isAgentEngineAuthEnvironmentKey(engine, key string) bool {
	...
	case agentEnginePi:
		switch key {
		case "PI_CODING_AGENT_DIR", "PI_CONFIG_DIR", "ANTHROPIC_API_KEY", "ANTHROPIC_AUTH_TOKEN", "ANTHROPIC_OAUTH_TOKEN", "ANTHROPIC_BASE_URL",
			"OPENAI_API_KEY", "OPENAI_BASE_URL", "OPENROUTER_API_KEY", "GOOGLE_API_KEY", "GEMINI_API_KEY",
			"MISTRAL_API_KEY", "GROQ_API_KEY", "CEREBRAS_API_KEY", "XAI_API_KEY", "COHERE_API_KEY", "DEEPSEEK_API_KEY",
			"AI_GATEWAY_API_KEY", "ZAI_API_KEY", "OPENCODE_API_KEY", "HF_TOKEN", "MINIMAX_API_KEY", "MINIMAX_CN_API_KEY", "KIMI_API_KEY",
			"COPILOT_GITHUB_TOKEN", "GOOGLE_CLOUD_PROJECT", "GCLOUD_PROJECT", "GOOGLE_CLOUD_LOCATION",
			"AZURE_OPENAI_API_KEY", "AZURE_OPENAI_ENDPOINT", "AZURE_OPENAI_BASE_URL", "AZURE_OPENAI_RESOURCE_NAME",
			"AZURE_OPENAI_API_VERSION", "AZURE_OPENAI_DEPLOYMENT_NAME_MAP", "OPENAI_API_VERSION",
			"AWS_ACCESS_KEY_ID", "AWS_SECRET_ACCESS_KEY", "AWS_SESSION_TOKEN", "AWS_PROFILE", "AWS_REGION", "AWS_DEFAULT_REGION",
			"AWS_BEARER_TOKEN_BEDROCK", "AWS_CONFIG_FILE", "AWS_SHARED_CREDENTIALS_FILE", "AWS_WEB_IDENTITY_TOKEN_FILE",
			"AWS_ROLE_ARN", "AWS_ROLE_SESSION_NAME", "AWS_CONTAINER_CREDENTIALS_RELATIVE_URI", "AWS_CONTAINER_CREDENTIALS_FULL_URI",
			"AWS_CONTAINER_AUTHORIZATION_TOKEN", "AWS_CONTAINER_AUTHORIZATION_TOKEN_FILE", "AWS_ENDPOINT_URL_BEDROCK_RUNTIME",
			"AWS_BEDROCK_SKIP_AUTH", "GOOGLE_APPLICATION_CREDENTIALS":
			return true
		}
	}
	return false
