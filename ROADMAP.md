...
- Records branch / PR handoff state from Issue Detail using captured source evidence, with personal desktop PR creation through local `gh`; GitHub App-backed team PR creation/refresh remains a server-owned executor gap.
