...
- Server-managed workflow skills should reduce issue handoff friction for mspace-owned flows and user-invoked issue comments. Workspaces can inspect pinned skill revisions, manage basic custom skills, and control built-in invocation visibility, but mspace should not become a generic skill marketplace or remote installer.
