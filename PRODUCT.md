...
- Server-managed workflow skills should reduce issue handoff friction for mspace-owned flows and user-invoked issue comments. Workspaces can manage basic custom skills and built-in invocation visibility, but mspace should not become a generic skill marketplace or remote installer.
