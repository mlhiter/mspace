...
func loadConfig() control.Config {
	return control.Config{
		...
		GitHubAppID:                strings.TrimSpace(os.Getenv("MSPACE_GITHUB_APP_ID")),
		GitHubAppClientID:          strings.TrimSpace(os.Getenv("MSPACE_GITHUB_APP_CLIENT_ID")),
		GitHubAppPrivateKey:        strings.TrimSpace(os.Getenv("MSPACE_GITHUB_APP_PRIVATE_KEY")),
